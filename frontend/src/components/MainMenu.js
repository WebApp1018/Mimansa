...
const MainMenu = (props) => {
    ...
    const maestros_sub_menu = [
        ...
        { key: 'locnprintermap', text: 'Mapeo - Ubicación/Impresora', as: Link, to: '/locnprintermap/list' },
      ]

    const pack_from_tote_sub_menu = [
        { key: 'pack_from_tote', text: 'Empacar desde TOTE', as: Link, to: '/location' },
        { key: 'tote_details', text: 'Consulta de Tote', as: Link, to: '/tote_detail' },
      ]
    ...
    return (
        <>
            <Menu fluid inverted widths={5} attached>
                ...
                <Dropdown text='Flujo - Empaque' options={pack_from_tote_sub_menu} simple item />
                <Dropdown text='Despacho WEB' options={despacho_web_sub_menu} simple item />
