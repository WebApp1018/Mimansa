...
const LoadScreen = () => {
    ...
    useEffect(() => {
        ...
        if (scanInfo === null || scanInfo.login_user_id === undefined) {
            ...
            if (scanInfo !== null && scanInfo.load_info !== undefined) {
                var newInfo = { login_user_id: scanInfo.login_user_id, whse: scanInfo.whse, whse_name: scanInfo.whse_name, load_info: scanInfo.load_info };
    ...
    const validateLoad = () => {
        ...
        apiValidateLoad({ whse: whse, load_nbr: load_nbr, login_user_id: scanInfo.login_user_id })
            .then(res => {
                console.log('===== res: ', res);
                setLoading(false);
                if (res) {
        ...
        <Grid>
            ...
            <Grid.Column align="center" width={1}></Grid.Column>
                ...
                <Header align="center" as='h1'>Despacho WEB</Header>
                    <DespachoWebProgressTab load_tab_active={true} load_tab_disabled={false}/>
